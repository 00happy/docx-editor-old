## API Report File for "@ucontract/docx-editor-react"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AgentResponse } from '@ucontract/docx-editor-core/types/agentApi';
import { AIAction } from '@ucontract/docx-editor-core/types/agentApi';
import { ColorValue } from '@ucontract/docx-editor-core/types/document';
import { createDefaultFindOptions } from '@ucontract/docx-editor-core/utils/findReplace';
import { createDefaultListState } from '@ucontract/docx-editor-core/utils/listState';
import { createSearchPattern } from '@ucontract/docx-editor-core/utils/findReplace';
import { CSSProperties } from 'react';
import { Document as Document_2 } from '@ucontract/docx-editor-core/types/document';
import { escapeRegexString } from '@ucontract/docx-editor-core/utils/findReplace';
import { findAllMatches } from '@ucontract/docx-editor-core/utils/findReplace';
import { findInDocument } from '@ucontract/docx-editor-core/utils/findReplace';
import { findInParagraph } from '@ucontract/docx-editor-core/utils/findReplace';
import { FindMatch } from '@ucontract/docx-editor-core/utils/findReplace';
import { FindOptions } from '@ucontract/docx-editor-core/utils/findReplace';
import { FindResult } from '@ucontract/docx-editor-core/utils/findReplace';
import { FontOption } from '@ucontract/docx-editor-core/utils/fontOptions';
import { formatPageRange as formatPrintPageRange } from '@ucontract/docx-editor-core';
import { getDefaultHighlightOptions } from '@ucontract/docx-editor-core/utils/findReplace';
import { getDefaultPrintOptions } from '@ucontract/docx-editor-core';
import { getMatchCountText } from '@ucontract/docx-editor-core/utils/findReplace';
import { HighlightOptions } from '@ucontract/docx-editor-core/utils/findReplace';
import { isEmptySearch } from '@ucontract/docx-editor-core/utils/findReplace';
import { isPrintSupported } from '@ucontract/docx-editor-core';
import { ListState } from '@ucontract/docx-editor-core/utils/listState';
import { openPrintWindow } from '@ucontract/docx-editor-core';
import { ParagraphAlignment } from '@ucontract/docx-editor-core/types/document';
import { ParsedClipboardContent } from '@ucontract/docx-editor-core/utils';
import { parsePageRange } from '@ucontract/docx-editor-core';
import { PrintOptions } from '@ucontract/docx-editor-core';
import * as React$1 from 'react';
import React__default from 'react';
import { ReactNode } from 'react';
import { replaceAllInContent } from '@ucontract/docx-editor-core/utils/findReplace';
import { replaceFirstInContent } from '@ucontract/docx-editor-core/utils/findReplace';
import { scrollToMatch } from '@ucontract/docx-editor-core/utils/findReplace';
import { SectionProperties } from '@ucontract/docx-editor-core/types/document';
import { SelectionContext } from '@ucontract/docx-editor-core/types/agentApi';
import { Style } from '@ucontract/docx-editor-core/types/document';
import { StyleType } from '@ucontract/docx-editor-core/types/document';
import { Table } from '@ucontract/docx-editor-core/types/document';
import { TableCell } from '@ucontract/docx-editor-core/types/document';
import { TabStop } from '@ucontract/docx-editor-core/types/document';
import { Theme } from '@ucontract/docx-editor-core/types/document';
import { TranslationKey } from '@ucontract/docx-editor-i18n';
import { triggerPrint } from '@ucontract/docx-editor-core';
