...
export const PACKAGES = [
  {
    name: '@ucontract/docx-editor-core',
    root: 'packages/core',
    pkgSlug: 'docx-editor-core',
  },
  {
    name: '@ucontract/docx-editor-i18n',
    root: 'packages/i18n',
    pkgSlug: 'docx-editor-i18n',
  },
  {
    name: '@ucontract/docx-editor-react',
    root: 'packages/react',
