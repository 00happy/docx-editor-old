...
import { createEmptyDocument, findStartPosForParaId } from '@ucontract/docx-editor-core';
import { setSuggestionMode } from '@ucontract/docx-editor-core/prosemirror/plugins';
...
import { TextSelection } from '@ucontract/docx-editor-core/prosemirror';
import {
  acceptChangeById,
  rejectChangeById,
  acceptAllChanges,
...
import { loadFont } from '@ucontract/docx-editor-core/utils';
import { DocxEditor, type DocxEditorRef } from '@ucontract/docx-editor-react';
import {
  AgentChatLog,
  type AgentMessage,
  getToolDisplayName,
} from '@ucontract/docx-editor-agents/react';
...
export function App() {
  ...
  // `loadFont(name)` from `@ucontract/docx-editor-core/utils` directly.
