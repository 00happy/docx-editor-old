...
import { type DocxEditorRef } from '@ucontract/docx-editor-react';
import { createEmptyDocument } from '@ucontract/docx-editor-core';
import {
  AgentChatLog,
  AgentComposer,
  AgentSuggestionChip,
...
import { toAgentMessages } from '@ucontract/docx-editor-agents/ai-sdk/react';
...
const DocxEditor = dynamic(
  () => import('@ucontract/docx-editor-react').then((m) => ({ default: m.DocxEditor })),
  {
    ssr: false,
    loading: () => (
      <div
...
// chips) ships from `@ucontract/docx-editor-react`. The welcome card matches
