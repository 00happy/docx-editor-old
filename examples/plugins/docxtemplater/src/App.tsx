...
import { PluginHost, templatePlugin } from '@ucontract/docx-editor-react/plugin-api';
import { createEmptyDocument, type Document } from '@ucontract/docx-editor-core';
    ...
    <div style={styles.container}>
      <header style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          >
            <h1 style={styles.title}>@ucontract/docx-editor-react</h1>
          </a>
