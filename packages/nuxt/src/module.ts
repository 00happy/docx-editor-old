/**
 * @ucontract/nuxt-docx-editor
 *
 * Nuxt module that wraps the `@ucontract/docx-editor-vue` adapter so Nuxt apps
...
const COMPOSABLES_SUBPATH = '@ucontract/docx-editor-vue/composables';
const STYLES_SUBPATH = '@ucontract/docx-editor-vue/styles.css';

// Public composables re-exported by `@ucontract/docx-editor-vue/composables`.
...
export interface ModuleOptions {
   ...
   * Set to `false` to import `@ucontract/docx-editor-vue/styles.css` yourself.
   * Defaults to `true`.
   */
...
const module: NuxtModule<ModuleOptions> = defineNuxtModule<ModuleOptions>({
  meta: {
    name: '@ucontract/nuxt-docx-editor',
  ...
  setup(options, nuxt) {
    ...
    optimizeDeps.include = [
      ...(optimizeDeps.include ?? []),
      '@ucontract/docx-editor-core',
      '@ucontract/docx-editor-vue',
    ];
