 ...
 * and locale data live in `@ucontract/docx-editor-i18n`; this module wraps
...
import { createT, deepMerge, en } from '@ucontract/docx-editor-i18n';
import type { LocaleStrings, TFunction, Translations } from '@ucontract/docx-editor-i18n';
