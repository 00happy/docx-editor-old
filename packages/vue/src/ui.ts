 ...
 * `@ucontract/docx-editor-react/ui { ColorPicker, FontPicker }` and
 * swaps to `@ucontract/docx-editor-vue/ui` works without surface
 * changes.
 *
 * @example
 * ```ts
 * import { Toolbar, FontPicker, ColorPicker } from '@ucontract/docx-editor-vue/ui';
 * ```
 *
