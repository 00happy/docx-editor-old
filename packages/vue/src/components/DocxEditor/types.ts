...
import type { SelectionState } from '@ucontract/docx-editor-core/prosemirror';
import type { DocxInput } from '@ucontract/docx-editor-core/utils';
import type { ScrollToParaIdOptions } from '@ucontract/docx-editor-core/utils';
import type { FontOption } from '@ucontract/docx-editor-core/utils/fontOptions';
import type { FontDefinition } from '@ucontract/docx-editor-core/utils';
import type { StyleValue, VNodeChild } from 'vue';
import type { EditorRefLike } from '@ucontract/docx-editor-agents/bridge';
import type { PMContentControl } from '@ucontract/docx-editor-core/prosemirror';
