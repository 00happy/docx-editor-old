...
import type { HeaderFooter, BlockContent } from '@ucontract/docx-editor-core/types/content';
import type { Document, SectionProperties } from '@ucontract/docx-editor-core/types/document';
import { findImageElement } from '@ucontract/docx-editor-core/layout-painter';
import {
  detectTableInsertHover,
  TABLE_INSERT_HIDE_DELAY_MS,
} from '@ucontract/docx-editor-core/layout-bridge/tableInsertHover';
import {
...
export interface UsePagesPointerOptions {
  ...
  getHfPmView?: (
    hf: import('@ucontract/docx-editor-core/types/content').HeaderFooter
