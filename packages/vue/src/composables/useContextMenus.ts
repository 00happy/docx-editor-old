...
import { getTableContext } from '@ucontract/docx-editor-core/prosemirror/extensions/nodes/TableExtension';
import type { ImageLayoutTarget } from '@ucontract/docx-editor-core/prosemirror/commands';
