...
import { collectHeadings } from '@ucontract/docx-editor-core/utils/headingCollector';
import type { HeadingInfo } from '@ucontract/docx-editor-core/utils/headingCollector';
