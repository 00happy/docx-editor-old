...
import { extractTrackedChanges } from '@ucontract/docx-editor-core/prosemirror/utils/extractTrackedChanges';
import { findElementAtPosition } from '../utils/domQueries';
import { createComment as createCommentCore } from '@ucontract/docx-editor-core/prosemirror/commentOps';
import {
  seedCommentAllocator,
  PENDING_COMMENT_ID,
  type CommentIdAllocator,
} from '@ucontract/docx-editor-core/prosemirror/commentIdAllocator';
