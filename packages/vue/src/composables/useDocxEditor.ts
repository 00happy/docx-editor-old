...
import { parseDocx } from '@ucontract/docx-editor-core/docx/parser';
import {
  getRenderableDocumentFonts,
  getEmbeddedFontFamilies,
} from '@ucontract/docx-editor-core/utils';
import type { FontOption } from '@ucontract/docx-editor-core/utils/fontOptions';
import {
  toProseDoc,
  createEmptyDoc,
  headerFooterToProseDoc,
  proseDocToBlocks,
} from '@ucontract/docx-editor-core/prosemirror/conversion';
import { fromProseDoc } from '@ucontract/docx-editor-core/prosemirror/conversion/fromProseDoc';
import { schema, ensureParaIdsInState } from '@ucontract/docx-editor-core/prosemirror';
import { singletonManager } from '@ucontract/docx-editor-core/prosemirror/schema';
import {
  createSuggestionModePlugin,
  setSuggestionMode,
  createDocumentStylesPlugin,
  createDocumentContextPlugin,
} from '@ucontract/docx-editor-core/prosemirror/plugins';
import {
  ExtensionManager,
  createStarterKit,
} from '@ucontract/docx-editor-core/prosemirror/extensions';
import type { CommandMap } from '@ucontract/docx-editor-core/prosemirror/extensions/types';
import {
  measureBlocksWithFloats,
  measureParagraph,
} from '@ucontract/docx-editor-core/layout-bridge/measuring';
import type {
  FloatingImageZone,
  FloatPageGeometry,
} from '@ucontract/docx-editor-core/layout-bridge/measuring';
...
import {
  ...
  stripScrollFlag,
} from '@ucontract/docx-editor-core/editor';
import {
  DEFAULT_TEXTBOX_MARGINS,
  DEFAULT_TEXTBOX_WIDTH,
  assertExhaustiveFlowBlock,
} from '@ucontract/docx-editor-core/layout-engine';
import { renderPages } from '@ucontract/docx-editor-core/layout-painter/renderPage';
import type {
  FlowBlock,
  Layout,
  Measure,
  ...
  ImageBlock,
  TextBoxBlock,
} from '@ucontract/docx-editor-core/layout-engine/types';
import {
  buildBlockLookup,
  enclosingSdtGroupIds,
  applySdtFocus,
} from '@ucontract/docx-editor-core/layout-painter';
import type { Document } from '@ucontract/docx-editor-core/types/document';
import type { LayoutSelectionGate } from '@ucontract/docx-editor-core/prosemirror';

// ProseMirror CSS — must be imported for the hidden editor to work
import 'prosemirror-view/style/prosemirror.css';
import '@ucontract/docx-editor-core/prosemirror/editor.css';
...
// `@ucontract/docx-editor-core/layout-bridge` so React and Vue agree on
 ...
 *
 * `measureTableBlock` lives in `@ucontract/docx-editor-core/layout-bridge`
...
export interface UseDocxEditorReturn {
   ...
   */
  getHfPmView: (
    hf: import('@ucontract/docx-editor-core/types/document').HeaderFooter
  ) => EditorView | null;
...
export function useDocxEditor(options: UseDocxEditorOptions): UseDocxEditorReturn {
  ...
  async function save(): Promise<Blob | null> {
    ...
    const { repackDocx, createDocx } = await import('@ucontract/docx-editor-core/docx/rezip');
    const { injectReplyRangeMarkers, injectTCReplyRangeMarkers } =
      await import('@ucontract/docx-editor-core/docx');
