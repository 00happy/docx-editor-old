...
// Library build for @ucontract/docx-editor-vue. Vite (not tsup) because the
...
export default defineConfig({
  plugins: [
    ...
    dts({
      ...
      entryRoot: 'src',
      // Keep workspace package names (`@ucontract/docx-editor-core`,
      // `@ucontract/docx-editor-i18n`) intact in published declarations.
