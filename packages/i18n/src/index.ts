/**
 * Shared locale data, types, and runtime helpers for the @ucontract
 ...
 * } from '@ucontract/docx-editor-i18n';
 * ```
 *
 ...
 * @example
 * ```ts
 * import { deepMerge, createT, en, de } from '@ucontract/docx-editor-i18n';
