 ...
 * @example
 * ```ts
 * import { createMcpServer, startStdioServer } from '@ucontract/docx-editor/mcp';
 * import { pluginRegistry, docxtemplaterPlugin } from '@ucontract/docx-editor/core-plugins';
 *
 * // Register plugins
