 ...
 * @example
 * ```ts
 * import { acceptChange } from '@ucontract/docx-editor-core/prosemirror/commands';
 ...
 * @example
 * ```ts
 * import { acceptAllChanges } from '@ucontract/docx-editor-core/prosemirror/commands';
 ...
 * @example
 * ```ts
 * import { acceptChangeById } from '@ucontract/docx-editor-core/prosemirror/commands';
