 ...
 * to do anything** — both adapters (`@ucontract/docx-editor-react`,
 * `@ucontract/docx-editor-vue`) auto-mount this inside the `DocxEditor`
 ...
 * @example
 * ```ts
 * import { createSuggestionModePlugin } from '@ucontract/docx-editor-core/prosemirror/plugins';
 *
