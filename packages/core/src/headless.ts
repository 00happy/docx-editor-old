/**
 * @ucontract/docx-editor-core/headless
 *
 ...
 * @example
 * ```ts
 * import { DocumentAgent, parseDocx, pluginRegistry } from '@ucontract/docx-editor-core/headless';
 * import { docxtemplaterPlugin } from '@ucontract/docx-editor-core/core-plugins';
 *
 * // Register plugins
