...
```tsx
import { DocxEditor, PluginHost, templatePlugin } from '@ucontract/docx-editor-react';
import '@ucontract/docx-editor-react/styles.css';
...
```tsx
import { DocxEditor, PluginHost } from '@ucontract/docx-editor-react';
import { createPlugin } from '@ucontract/docx-editor-react';
...
```tsx
import { processTemplate } from '@ucontract/docx-editor-react';
