...
import type { Document, Theme } from '@ucontract/docx-editor-core/types/document';
...
import type { Comment } from '@ucontract/docx-editor-core/types/content';
import type { Translations } from '@ucontract/docx-editor-i18n';
...
import { DocumentAgent } from '@ucontract/docx-editor-core/agent';
import { DefaultLoadingIndicator, DefaultPlaceholder, ParseError } from './DocxEditorHelpers';
import { type DocxInput } from '@ucontract/docx-editor-core/utils';
import type { FontDefinition, ScrollToParaIdOptions } from '@ucontract/docx-editor-core/utils';
import { useFontLifecycle } from '../hooks/useFontLifecycle';
import { useTableSelection } from '../hooks/useTableSelection';
import { useDocumentHistory } from '../hooks/useHistory';

// Extension system
import { createStarterKit } from '@ucontract/docx-editor-core/prosemirror/extensions';
import { ExtensionManager } from '@ucontract/docx-editor-core/prosemirror/extensions';
import {
...
} from '@ucontract/docx-editor-core/prosemirror';
import type { ContentControlFilter, ContentControlValue } from '@ucontract/docx-editor-core/agent';
import {
  acceptChange,
  rejectChange,
  acceptChangeById,
...
import { collectHeadings } from '@ucontract/docx-editor-core/utils';
import {
...
interface EditorState {
  ...
  paragraphTabs: import('@ucontract/docx-editor-core/types/document').TabStop[] | null;
...
// `@ucontract/docx-editor-core/docx` so React + Vue share the same
