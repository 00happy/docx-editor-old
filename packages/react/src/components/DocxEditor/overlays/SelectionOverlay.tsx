...
import type { SelectionRect, CaretPosition } from '@ucontract/docx-editor-core/layout-bridge';
...
export function useSelectionOverlay(
  ...
  layout: import('@ucontract/docx-editor-core/layout-engine').Layout | null,
  blocks: import('@ucontract/docx-editor-core/layout-engine').FlowBlock[],
  measures: import('@ucontract/docx-editor-core/layout-engine').Measure[]
): {
  selectionRects: SelectionRect[];
  caretPosition: CaretPosition | null;
} {
  ...
  useEffect(() => {
    ...
    import('@ucontract/docx-editor-core/layout-bridge').then(
