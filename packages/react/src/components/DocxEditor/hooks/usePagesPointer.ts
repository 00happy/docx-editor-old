...
import type { CaretPosition, SelectionRect } from '@ucontract/docx-editor-core/layout-bridge';
import {
  clickToPosition,
  clickToPositionDom,
...
import { addColumnRight, addRowBelow } from '@ucontract/docx-editor-core/prosemirror';
import {
  captureInlinePositionEmu,
  findImageElement as coreFindImageElement,
  hitTestImage,
} from '@ucontract/docx-editor-core/layout-painter';
import type { WrapType } from '@ucontract/docx-editor-core/docx/wrapTypes';
...
} from '@ucontract/docx-editor-core/prosemirror/cellDragSelection';
