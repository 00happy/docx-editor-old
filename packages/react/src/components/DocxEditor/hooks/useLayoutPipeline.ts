...
import type { FlowBlock, Layout, Measure } from '@ucontract/docx-editor-core/layout-engine';
import { getMargins, getPageSize, getColumns } from '@ucontract/docx-editor-core/layout-bridge';
...
import { findVerticalScrollParentOrRoot } from '@ucontract/docx-editor-core/utils/findVerticalScrollParent';
import type {
  Document,
  HeaderFooter,
  SectionProperties,
  StyleDefinitions,
  Theme,
} from '@ucontract/docx-editor-core/types/document';
  ...
  const runLayoutPipeline = useCallback(
    (state: EditorState) => {
      ...
      try {
        ...
        // `@ucontract/docx-editor-core/editor`. Paint + scroll/events stay here.
        const {
          blocks: newBlocks,
