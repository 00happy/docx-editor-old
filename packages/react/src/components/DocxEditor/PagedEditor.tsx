...
// Layout bridge
import { DEFAULT_PAGE_HEIGHT_PX } from '@ucontract/docx-editor-core/layout-bridge';
...
export interface PagedEditorProps {
  ...
  extensionManager?: import('@ucontract/docx-editor-core/prosemirror/extensions').ExtensionManager;
