 ...
 * live in `@ucontract/docx-editor-core/layout-bridge` and are shared with the
...
export { applyCellSelectionHighlight } from '@ucontract/docx-editor-core/layout-bridge';
