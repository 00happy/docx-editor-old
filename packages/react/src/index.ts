/**
 * @ucontract/docx-editor-react
 *
 * Curated root entry for the documented React editor API. Advanced surfaces
 * stay public through explicit subpaths:
 * - `@ucontract/docx-editor-react/ui`
 * - `@ucontract/docx-editor-react/dialogs`
 * - `@ucontract/docx-editor-react/hooks`
 * - `@ucontract/docx-editor-react/plugin-api`
 *
 * Framework-agnostic document utilities live in `@ucontract/docx-editor-core`.
 * Agent/MCP surfaces live in `@ucontract/docx-editor-agents`.
 *
...
// Document factory helpers — re-exported from `@ucontract/docx-editor-core` so
