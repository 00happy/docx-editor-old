/**
 * @ucontract/docx-editor-agents/ai-sdk/server
 *
 ...
 * `getToolSchemas` from `@ucontract/docx-editor-agents/server` and shape it
 * however your runtime expects.
 *
 * @example
 * ```ts
 * import { getAiSdkTools } from '@ucontract/docx-editor-agents/ai-sdk/server';
 ...
 * `@ucontract/docx-editor-agents/ai-sdk/react` or
