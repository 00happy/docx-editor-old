/**
 * @ucontract/docx-editor-agents/ai-sdk/vue
 *
 ...
 * import { toAgentMessages } from '@ucontract/docx-editor-agents/ai-sdk/vue';
 * import { AgentChatLog } from '@ucontract/docx-editor-agents/vue';
 *
 * const chat = useChat({ ... });
