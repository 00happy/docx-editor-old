import type { Document, DocumentBody } from '@ucontract/docx-editor-core/headless';
import { parseDocx } from '@ucontract/docx-editor-core/headless';
import type {
  ContentBlock,
  GetContentOptions,
  ReviewChange,
...
export class DocxReviewer {
  ...
  async toBuffer(): Promise<ArrayBuffer> {
    ...
    const { repackDocx } = await import('@ucontract/docx-editor-core/headless');
