/**
 * @ucontract/docx-editor-agents/bridge
 *
 * Editor bridge that connects agent tools to a live `DocxEditor` instance.
 * Framework-agnostic. The React adapter lives in
 * `@ucontract/docx-editor-agents/react`.
 *
 * @example
 * ```ts
 * import { createEditorBridge } from '@ucontract/docx-editor-agents/bridge';
...
} from '@ucontract/docx-editor-core/utils/paragraphFlashTypes';
...
function getDocumentBody(
...
): import('@ucontract/docx-editor-core/headless').DocumentBody | null {
  ...
  if (pagedRef) {
    const doc = pagedRef.getDocument() as
      | import('@ucontract/docx-editor-core/headless').Document
      | null;
